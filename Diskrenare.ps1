...
#GUI Variables
$FormTitleText = "Diskrenare av Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Välj disk:"
$FreeSpaceLabelText = "Fritt utrymme (gigabyte): "
$TotalSpaceLabelText = "Totalt utrymme (gigabyte): "
$JunkFoundLabelText = "skräp hittades (gigabyte):"
$CleanDiskBtnText = "Rensa disk *Ta bort filer*"
$SpaceCleanedLabelText = "Renat utrymme (gigabyte): "
$LogFileLabelText = "Loggfil hittades: $abcdefg"
$CreditLabelText = "Manus av Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Loggfil hittades"
$AnalyzingDriveText = "Analyserar enheter..."
$BrowsersAreRunningText = "Webbläsare körs... Meddela användare..."
$PleaseCloseBrowsersText = "Stäng alla webbläsare och försök igen."
$CleaningDriveText = "Rengör enheten..."
